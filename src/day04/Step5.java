...
public class Step5 { // c s
    public static void main(String[] args) { //m s
        ...
        while (true) { // w s
            System.out.println("-------------- EZ 독서실 ---------------");
            System.out.println("-------------- 좌석 현황표 -------------");
            System.out.printf("%s %11s %11s \n", "좌석1","좌석2","좌석3" );
            System.out.printf("%s %11s %11s \n", 좌석1,좌석2,좌석3 );
            System.out.printf("%s %10s %10s \n", 좌석1시 + "시", 좌석2시 + "시", 좌석3시 + "시");
            System.out.printf("%s %10s %10s \n", 좌석1분 + "분",좌석2분 + "분",좌석3분 + "분");
            System.out.println("---------------------------------------");


            System.out.print("독서실 입실이신가요? 퇴실이신가요? >> ");
            ...
            if ( ch.equals("입실")) {
                ...
                if (좌석선택.equals("좌석1"));{
                    if (좌석1.equals("빈좌석"));{
                        ...
                        System.out.print("입실 '분'을 입력해주세요 >> ");
