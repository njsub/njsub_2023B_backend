...
public class Step5 { //c s
    ...
    public static void main(String[] args) { // c m
        ...
        /*
        System.out.print("점수를 입력하세요 : "); int Grades = scanner.nextInt();
        ...
        */
        ...
        /*
            ...
            System.out.print("출차 시간을 입력하세요 : "); int 시 = scanner.nextInt();
            System.out.print("출차 분을 입력하세요 : ");   int 분 = scanner.nextInt();
            int 금액 = 0;

            if(시 > 14){
                int 총시간 = ((시 - 14) * 60) + 분 - 30;
                금액 = 총시간 * 1000;
